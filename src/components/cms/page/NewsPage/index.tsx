                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                        {[1, 2, 3, 4, 5, 6].map((item) => (
                            <article key={item} className="group relative">
                                ...
                                <div className="relative h-full bg-gradient-to-br from-slate-900/90 via-slate-800/80 to-slate-900/90 rounded-2xl border border-white/10 overflow-hidden backdrop-blur-sm transition-transform duration-500 group-hover:scale-[1.02]">
                                    <div className="relative h-48 bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 overflow-hidden">
                                    ...
                                    <div className="p-6 space-y-4">
                                        <div className="flex gap-2">
                                            <span className="px-3 py-1 text-xs font-bold uppercase tracking-wider rounded-full bg-blue-500/20 text-blue-300 border border-blue-500/30">
                                                Technology
                                            </span>
                                        </div>
                                        <h3 className="text-xl font-bold text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400 transition-all duration-300">
                                            Breaking: Revolutionary News Article {item}
                                        </h3>
                                        <p className="text-slate-400 text-sm leading-relaxed">
                                            Discover the latest updates and insights that are shaping the future of technology and innovation.
                                        </p>
                                        <div className="flex items-center gap-2 text-blue-400 font-semibold text-sm group-hover:gap-4 transition-all duration-300">
